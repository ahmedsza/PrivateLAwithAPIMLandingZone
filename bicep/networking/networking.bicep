...
param vnetIntegrationAddressPrefix string = '10.2.8.0/24'
/*
...
var vnetSubnetName='snet-vnet-${workloadName}-${deploymentEnvironment}-${location}-001'
...
output vnetSubnetid string = '${vnetApimCs.id}/subnets/${vnetSubnetName}'
